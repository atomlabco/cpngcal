...
var Schedule = (function () {
    function Schedule(el, differs) {
        ...
        this.originalEventSourceId = 'originalEvents';
    }
    ...
    Schedule.prototype.initialize = function () {
        ...
        if (this.events) {
          ...
          this.schedule.fullCalendar('addEventSource', {
            events: this.events,
            id: this.originalEventSourceId
          });
    ...
    Schedule.prototype.ngDoCheck = function () {
        ...
        if (this.schedule && changes) {
          ...
          var eventSources = this.schedule.fullCalendar('getEventSources'); 

          //this.schedule.fullCalendar('removeEventSource', this.originalEventSourceId);
          ...
          for (let source of eventSources) {
            ...
            if (source.id !== this.originalEventSourceId) {
              this.schedule.fullCalendar('addEventSource', source);
            }
            else {
              if (this.events) {
                this.schedule.fullCalendar('addEventSource', {
